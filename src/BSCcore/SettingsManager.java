...
public class SettingsManager
{
    ...
    {
        return getInstance(Thread.currentThread().getContextClassLoader().getResource("biscicolsettings.props").getFile());
     ...
     * SettingsManager instance, then a new SettingsManager object will be
